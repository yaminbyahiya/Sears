...
class Product_Question {
	...
	public function initialize() {
		...
		// Add filter for `question` comment type.
		add_filter( 'admin_comment_types_dropdown', [ $this, 'add_question_comment_filter' ] );
	}
	...
	/**
	 * Add Product Questions filter for `question` comment type.
	 *
	 * @param array $comment_types Array of comment type labels keyed by their name.
	 *
	 * @return array
	 */
	public static function add_question_comment_filter( array $comment_types ) {
		$comment_types['question'] = __( 'Product Questions', 'minimog' );
