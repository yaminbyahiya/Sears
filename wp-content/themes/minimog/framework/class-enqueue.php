...
if ( ! class_exists( 'Minimog_Enqueue' ) ) {
	class Minimog_Enqueue {
		...
		public function register_swiper() {
			...
			wp_register_script( 'minimog-swiper-wrapper', MINIMOG_THEME_URI . "/assets/js/swiper-wrapper{$min}.js", array( 'swiper' ), MINIMOG_THEME_VERSION, true );
		...
		public function frontend_scripts() {
			...
			wp_register_script( 'minimog-grid-layout', MINIMOG_THEME_ASSETS_URI . "/js/grid-layout{$min}.js", array(
				'jquery',
				'matchheight',
				'isotope-masonry',
				'isotope-packery',
			...
			if ( is_rtl() ) {
				...
				wp_enqueue_style( 'minimog-style', get_template_directory_uri() . "/style{$min}.css" );
			}
