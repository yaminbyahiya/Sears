...
if ( ! class_exists( 'Minimog_Redux' ) ) {
	class Minimog_Redux {
		...
		public function initialize() {
			...
			add_action( 'init', [ $this, 'remove_demo_link' ] );
		...
		public function register_sections() {
			...
			if ( \Minimog\Dokan\Utils::instance()->is_activated() ) {
				Redux::set_section( Minimog_Redux::OPTION_NAME, [
		...
		public function setup() {
			$args = array(
				...
				'intro_text'                => wp_kses( sprintf(
					__( 'Thank you for using our theme, please reward it a full five-star &#9733;&#9733;&#9733;&#9733;&#9733; rating. <br/> <a href="%s" target="_blank">Need support?</a> | <a href="%s">Check Update</a>', 'minimog' ),
					esc_url( 'https://thememove.ticksy.com/submit/#100019229' ),
