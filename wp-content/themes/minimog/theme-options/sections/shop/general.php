...
Redux::set_section( Minimog_Redux::OPTION_NAME, array(
	...
	'fields'     => array(
		...
		array(
			...
			'options' => array(
				'label'                   => esc_html__( 'Rounded Label', 'minimog' ),
				'semi-round-border-label' => esc_html__( 'Semi Rounded & Border Label', 'minimog' ),
				'square-label'            => esc_html__( 'Square Label', 'minimog' ),
			),
