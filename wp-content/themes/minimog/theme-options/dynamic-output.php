	...
	public function set_field_outputs() {
		self::$field_outputs = [
			...
			'title_bar_minimal_01_breadcrumb_text_color'         => [
				'type'   => 'color',
				'output' => [ '.page-title-bar-minimal-01 .insight_core_breadcrumb li' ],
			],
			'title_bar_minimal_01_breadcrumb_link_color'         => [
				'type'   => 'color',
				'output' => [ '.page-title-bar-minimal-01 .insight_core_breadcrumb a' ],
			],
			'title_bar_minimal_01_breadcrumb_link_hover_color'   => [
				'type'   => 'color',
				'output' => [ '.page-title-bar-minimal-01 .insight_core_breadcrumb a:hover' ],
			],
			'title_bar_minimal_01_breadcrumb_separator_color'    => [
				'type'   => 'color',
				'output' => [ '.page-title-bar-minimal-01 .insight_core_breadcrumb li + li:before' ],
			],
